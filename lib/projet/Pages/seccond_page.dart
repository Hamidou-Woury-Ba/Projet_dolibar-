...
import 'package:drawer_ui_challege/produit.dart';
        ...
        return GestureDetector(
          ...
          child: Stack(
            children: [
              ...
              Transform.translate(
                offset: Offset((maxSide * animationController.value / 4), 0),
                child: Transform(
                    transform: Matrix4.identity()
                      ..setEntry(3, 2, 0.001)
                      ..rotateY((-pi / 4 * animationController.value)),
                    alignment: Alignment.centerLeft,
                    child: const MyHomeWidgets(title: "page2")),
              ),
            ],
          ),
        );
